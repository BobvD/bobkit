---
name: design-explore
description: Use when a new feature, component, or screen needs UI or visual design. Detects the repo's design system (shadcn, Tailwind, CSS variables, component library), proposes 3-5 distinct design options in one self-contained HTML preview, gets multiple-choice feedback, and locks in a chosen direction that feeds the spec and BDD. Trigger for UI-facing work or when named design-explore / $design-explore.
targets: ["*"]
codexcli:
  short-description: Explore 3-5 UI designs grounded in the repo's design system
copilot:
  license: MIT
---
