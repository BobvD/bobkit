...
name: review-mr
description: >-
  Review a merge request or pull request from a GitHub/GitLab URL and post
  inline comments with concrete suggestions. Use when the user asks to review an
  MR/PR, explicitly names review-mr / $review-mr, or shares a PR/MR link asking
  for feedback.
---
# Review MR
