...
name: write-bdd
description: >-
  Generate Gherkin .feature files and step-definition stubs from a feature spec
  or freeform description. Use when the user asks to write BDD scenarios,
  Cucumber tests, Playwright BDD tests, generate .feature files, or explicitly
  names write-bdd / $write-bdd.
---
# Write BDD
